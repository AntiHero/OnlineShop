(function (factory) {
  ...
  Slick.prototype.initADA = function () {
    let _ = this;
    let numDotGroups = Math.ceil(_.slideCount / _.options.slidesToShow);
    let tabControlIndexes = _.getNavigableIndexes().filter((val) => {
  ...
  Slick.prototype.lazyLoad = function () {
    ...
    function loadImages(imagesScope) {
      $('img[data-lazy]', imagesScope).each(function () {
        let image = $(this);
        let imageSource = $(this).attr('data-lazy');
        let imageSrcSet = $(this).attr('data-srcset');
        let imageSizes =
    ...
    if (_.options.lazyLoad === 'anticipated') {
      ...
      let $slides = _.$slider.find('.slick-slide');
  ...
  Slick.prototype.progressiveLazyLoad = function (tryCount) {
    tryCount = tryCount || 1;
    let _ = this;
    let $imgsToLoad = $('img[data-lazy]', _.$slider);
    let image;
    let imageSource;
    let imageSrcSet;
    let imageSizes;
  ...
  Slick.prototype.registerBreakpoints = function () {
    ...
    let l;
    let responsiveSettings = _.options.responsive || null;
